...
Public Class uctrl_teacher_list
    Private Sub displayTeacher()
        Try
            comm = New MySqlCommand("SELECT a.id AS 'ID', b.teacher_id AS 'Teacher ID', b.fname AS 'First Name', b.mname AS 'Middle Name', b.lname AS 'Last Name', b.gender AS 'Gender', b.contact_number AS 'Contact Number', b.email_address AS 'Email Address', c.section_name AS 'Section Name', c.year_level AS 'Year Level' FROM tbl_teacher_section a, tbl_teacher b, tbl_section c WHERE a.teacher_id = b.teacher_id AND a.section_id = c.section_id", conn)
    ...
    Private Sub filteredSearch()
        Try
            ...
            ElseIf cmbFilter.Text = "By Name" Then
                comm = New MySqlCommand("SELECT a.id AS 'ID', b.teacher_id AS 'Teacher ID', b.fname AS 'First Name', b.mname AS 'Middle Name', b.lname AS 'Last Name', b.gender AS 'Gender', b.contact_number AS 'Contact Number', b.email_address AS 'Email Address', c.section_name AS 'Section Name', c.year_level AS 'Year Level' FROM tbl_teacher_section a, tbl_teacher b, tbl_section c WHERE a.teacher_id = b.teacher_id AND a.section_id = c.section_id AND b.fname LIKE '%" + txtSearchBox.Text + "%' OR b.mname LIKE '%" + txtSearchBox.Text + "%' OR b.lname LIKE '%" + txtSearchBox.Text + "%'", conn)
            ElseIf cmbFilter.Text = "By Gender" Then
                comm = New MySqlCommand("SELECT a.id AS 'ID', b.teacher_id AS 'Teacher ID', b.fname AS 'First Name', b.mname AS 'Middle Name', b.lname AS 'Last Name', b.gender AS 'Gender', b.contact_number AS 'Contact Number', b.email_address AS 'Email Address', c.section_name AS 'Section Name', c.year_level AS 'Year Level' FROM tbl_teacher_section a, tbl_teacher b, tbl_section c WHERE a.teacher_id = b.teacher_id AND a.section_id = c.section_id AND WHERE b.gender = '" & cmbGender.Text & "'", conn)
            End If
    ...
    Private Sub deleteTeacher(teacherID As String, userName As String)
        ...
        Try
            conn.Open()
            comm = New MySqlCommand("DELETE FROM tbl_accounts WHERE username = @uname", conn)
