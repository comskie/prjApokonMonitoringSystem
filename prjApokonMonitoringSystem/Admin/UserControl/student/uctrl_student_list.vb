    ...
    Private Sub count_rows()
        Try
            ...
            If cmbFilter.Text = "By Name" And txtSearchBox.Text <> String.Empty Then
                comm = New MySqlCommand("SELECT count(*) FROM tbl_student_section c, tbl_student d, tbl_section e WHERE c.student_id = d.lrn AND c.section_id = e.section_id AND (d.fname LIKE '%" + txtSearchBox.Text + "%' OR d.mname LIKE '%" + txtSearchBox.Text + "%' OR d.lname LIKE '%" + txtSearchBox.Text + "%') ORDER BY d.id ASC", conn)
