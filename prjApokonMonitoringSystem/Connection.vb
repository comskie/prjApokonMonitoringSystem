...
Module Connection
    ...
    Sub connect()
        ...
        'Try
        '    With conn
        '        .ConnectionString = "server=vmucrn65rion.ap-southeast-2.psdb.cloud;user=uni5ebv1yrc3;database=monitoring_system;port=3306;password=pscale_pw_roJcqGhDx6m_f7Fd2CnevLvMauZ6cnAL24UkXwsIURc;SslMode=VerifyFull"
